...
import 'package:flutter_todo/widgets/util/safe_list_view.dart';
import 'package:flutter_todo/widgets/todo/shortcuts_enabled_todo_fab.dart';

class SafeListPage extends StatefulWidget {
  final AppModel model;

  SafeListPage(this.model);

  @override
  State<StatefulWidget> createState() {
    return _SafeListPageState();
  }
}

class _SafeListPageState extends State<SafeListPage> {
  @override
  void initState() {
    widget.model.fetchSafes();
